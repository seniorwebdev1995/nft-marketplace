...
export const AuctionMembersInfo = ({auction}:{auction:IAuction}) => {
  ...
  const table: { type: "info" | "link"; label: string; value: string, link?: string }[] = [
    {
      ...
      value: `${auction.name} - ${auction.artist?.nickname}`,
    },
    {
      type: "info",
    ...
    },
    {
      ...
      value: auction.contractAddress,
      link: `${process.env.REACT_APP_MATIC_URL}/address/${auction.contractAddress}`,
    },
    // {
    //   type: "link",
